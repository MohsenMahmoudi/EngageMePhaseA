...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Mohand-Laptop\\Desktop\\glasgow_face_matching-master\\glasgow_face_matching_lastrun.py',
